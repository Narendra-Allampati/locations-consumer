...
public class parent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2229215555520584431L;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<com.maersk.geography.smds.operations.msk.parentAlternateCode>((int)size0, SCHEMA$.getField("alternateCodes").schema());
