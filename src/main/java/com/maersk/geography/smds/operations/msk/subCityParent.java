...
public class subCityParent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7050920770575668046L;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<com.maersk.geography.smds.operations.msk.subCityParentAlternateCode>((int)size0, SCHEMA$.getField("alternateCodes").schema());
