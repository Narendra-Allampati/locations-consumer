...
//    private int retryInitialIntervalSeconds;
    ...
    @Bean
    KafkaReceiver<String, GeographyMessage> kafkaReceiver() {
        return KafkaReceiver.create(kafkaReceiverOptions(consumerGroup, clientId, username, password, topicName));
    }

    private ReceiverOptions<String, GeographyMessage> kafkaReceiverOptions(String consumerGroup, String clientId, String username, String password, String topicName) {
        ...
        ReceiverOptions<String, GeographyMessage> options = ReceiverOptions.create(properties);
