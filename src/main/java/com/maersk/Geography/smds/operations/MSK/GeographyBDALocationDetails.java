...
public class GeographyBDALocationDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<GeographyBDALocationDetails> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a GeographyBDALocationDetails instance decoded from the given buffer
  ...
  public static GeographyBDALocationDetails fromByteBuffer(
   ...
   private java.lang.String bdaLocRowid;
   ...
   */
  public GeographyBDALocationDetails(java.lang.String bdaLocRowid, java.lang.String Name, java.lang.String Type, java.util.List<com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode> GeographyBDALocationAlternateCodeDetails) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: bdaLocRowid = value$ != null ? value$.toString() : null; break;
   ...
   */
  public java.lang.String getBdaLocRowid() {
    return bdaLocRowid;
  }
   ...
   */
  public void setBdaLocRowid(java.lang.String value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GeographyBDALocationDetails>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.Geography.smds.operations.MSK.GeographyBDALocationDetails.Builder setBdaLocRowid(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.Geography.smds.operations.MSK.GeographyBDALocationDetails.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.Geography.smds.operations.MSK.GeographyBDALocationDetails.Builder setType(java.lang.String value) {
    ...
    public GeographyBDALocationDetails build() {
      try {
        ...
        record.bdaLocRowid = fieldSetFlags()[0] ? this.bdaLocRowid : (java.lang.String) defaultValue(fields()[0]);
  ...
  @Override public void customEncode(org.apache.avro.io.Encoder out)
    throws java.io.IOException
  {
    if (this.bdaLocRowid == null) {
      out.writeIndex(0);
      out.writeNull();
    } else {
      out.writeIndex(1);
      out.writeString(this.bdaLocRowid);
    }
    ...
    if (this.GeographyBDALocationAlternateCodeDetails == null) {
      out.writeIndex(0);
      out.writeNull();
    } else {
      out.writeIndex(1);
      long size0 = this.GeographyBDALocationAlternateCodeDetails.size();
      out.writeArrayStart();
      out.setItemCount(size0);
      long actualSize0 = 0;
      for (com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode e0: this.GeographyBDALocationAlternateCodeDetails) {
        actualSize0++;
        out.startItem();
        e0.customEncode(out);
      }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        in.readNull();
        this.bdaLocRowid = null;
      } else {
        this.bdaLocRowid = in.readString();
      }
      ...
      if (in.readIndex() != 1) {
        in.readNull();
        this.GeographyBDALocationAlternateCodeDetails = null;
      } else {
        long size0 = in.readArrayStart();
        java.util.List<com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode> a0 = this.GeographyBDALocationAlternateCodeDetails;
        if (a0 == null) {
          a0 = new SpecificData.Array<com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode>((int)size0, SCHEMA$.getField("GeographyBDALocationAlternateCodeDetails").schema().getTypes().get(1));
          this.GeographyBDALocationAlternateCodeDetails = a0;
        } else a0.clear();
        SpecificData.Array<com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode>)a0 : null);
        for ( ; 0 < size0; size0 = in.arrayNext()) {
          for ( ; size0 != 0; size0--) {
            com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode e0 = (ga0 != null ? ga0.peek() : null);
            if (e0 == null) {
              e0 = new com.maersk.Geography.smds.operations.MSK.GeographyBDALocationAlternateCode();
            }
            e0.customDecode(in);
            a0.add(e0);
          }
