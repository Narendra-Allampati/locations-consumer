DROP TABLE IF EXISTS ADDRESSES, CONTACT_DETAILS, FACILITIES, FACILITY_ALTERNATE_CODE_LINKS, FACILITY_DETAILS, FACILITY_SERVICES, FACILITY_TYPE_LINKS, FACILITY_TYPES, FENCES, OPENING_HOURS, TRANSPORT_MODES, ALTERNATE_CODES, ALTERNATE_NAMES, GEO_ALTERNATE_CODE_LINKS, GEOGRAPHY, POSTAL_CODE;
